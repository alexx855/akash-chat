...
export const Chatbar: FC<Props> = ({
  ...
  return (
    <div
      className={`fixed top-0 bottom-0 z-50 flex h-full w-[260px] flex-none flex-col space-y-2 bg-[#242424] p-2 transition-all sm:relative sm:top-0`}
    >
      ...
      <div className="flex-grow overflow-auto">
        {selectedConversation && folders.length > 0 && (
